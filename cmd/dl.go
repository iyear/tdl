...
func NewDownload() *cobra.Command {
	...
	cmd.Flags().BoolVar(&opts.ForceOnlineCheck, "force-online-check", false, "force online file checking instead of using JSON metadata optimization (use with --skip-same)")
