...
func NewDownload() *cobra.Command {
	...
	cmd.Flags().BoolVar(&opts.ForceWebCheck, "force-web-check", false, "force network-based file checking instead of using JSON metadata optimization (use with --skip-same)")
